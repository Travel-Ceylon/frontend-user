...
function Navbar() {
  ...
  return (
    <nav className="w-full top-0 left-0 z-50 bg-white">
      <div className="relative flex items-center justify-between md:justify-between h-15 px-4 sm:px-10">
        {/* Left - Desktop Nav */}
        ...
        <div className="flex items-center gap-3 relative" ref={dropdownRef}>
          {user ? (
            ...
            <Link
              to="/login"
              className="hidden md:block px-4 py-1 bg-green-400 text-black text-base font-semibold rounded-lg hover:bg-green-500 transition"
            >
              Login
            </Link>
          )}
