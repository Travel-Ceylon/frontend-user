...
const staysOffers = [
  {
    ...
    description:
      "Arriving before standard check-in time? We’ll do our best to get your room ready early so you can relax or freshen up right away.",
  },
  {
    image: StaysOffer2,
    heading: "Special In-Room Amenities",
    description:
      "From bathrobes and spa kits to curated snacks or welcome flowers, enjoy thoughtful touches that elevate your comfort",
  },
  {
    image: StaysOffer3,
    heading: "Secure Booking Guarantee",
    description:
      "All bookings are protected with advanced encryption and instant confirmations, so you can plan with peace of mind.",
  },
  {
    image: StaysOffer4,
    heading: "Complimentary Airport Pickup",
    description:
      "Enjoy smooth airport-to-hotel transfers arranged by your host. It's free, punctual, and stress-free—no taxis or waiting in lines",
  },
];
